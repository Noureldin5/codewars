...
public class GlobalExceptionHandler {
    ...
    public com.example.codewars.exception.ExceptionResponse handlerNotFoundException(NotFoundException e) {
        return new com.example.codewars.exception.ExceptionResponse(
